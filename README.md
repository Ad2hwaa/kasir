...
![Global Mandiri Bimbel-Yayasan Cahaya Putra Ilmu](https://github.com/Ad2hwaa/kasir/blob/main/logo-cpi.png?raw=true)
...
![Flowchart kasir](https://github.com/Ad2hwaa/kasir/blob/main/kasir.png?raw=true)

## Compile dan Run

Untuk compile kode c++ ini, melalui terminal:
````
g++ kasir.cpp -o kasir
````
atau dalam perintah yang lebih sederhana,
````
make
````
sedangkan, untuk menjalankan aplikasi kasir, melalui terminal:
````
./kasir
````
# kasir
